...
for modelo in models:
    ...
    blob_name = 'forecast_US_{0}.parquet'.format(modelo)
...
dict_df['lasso'][['date','ship_to_party','material','model_type', 'feature_forecasted'] + features_forecast].to_csv('C:\\Users\\laura\\OneDrive\\Documents\\Ingredion II\\Jupyter Notebook\\Modelos\\ingredion_results_lasso_US.csv')
dict_df['gbm'][['date','ship_to_party','material','model_type', 'feature_forecasted'] + features_forecast].to_csv('C:\\Users\\laura\\OneDrive\\Documents\\Ingredion II\\Jupyter Notebook\\Modelos\\ingredion_results_gbm_US.csv')
dict_df['xgboost'][['date','ship_to_party','material','model_type', 'feature_forecasted'] + features_forecast].to_csv('C:\\Users\\laura\\OneDrive\\Documents\\Ingredion II\\Jupyter Notebook\\Modelos\\ingredion_results_xgboost_US.csv')
